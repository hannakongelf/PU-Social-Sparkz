...
export default function GameTemplate() {
  ...
  return (
    <form action={action}>
      ...
      <p className='mb-4'>
        Please fill out the fields below. Please note that some fields
      ...
      <div className='flex flex-col mb-3'>
        <label htmlFor='description'>Game description: <span className="text-red-500">*</span></label>
        <TextField id='desc' name='description' required/>
      </div>

      <div className='flex flex-col mb-3'>
        <label htmlFor='minplayers'>Minimum number of players: <span className="text-red-500">*</span></label>
      ...
      <div className='flex flex-col mb-3'>
        <label htmlFor='maxplayers'>Maximum number of players: <span className="text-red-500">*</span></label>
      ...
      <div className='flex flex-col mb-3'>
        <label htmlFor='category'>Please select a suiting category for your game:</label>
      </div>
      <div>
